...
export default function LogIn() {
  const { onSubmit, loginWithGoogle, loginWithMetamask, handleCaptchaChange } =
    useLogIn();
  return (
    <div className="flex flex-col gap-4 text-center w-80 max-w-[calc(100vw-20px)]">
      ...
      <form className="flex flex-col gap-4 w-full" onSubmit={onSubmit}>
        ...
        <Input
          ...
          required
        />
        <Button type="submit" size="xl" height="l">
          Log in
        </Button>
      </form>
      <Button variant="google" size="xl" height="l" onClick={loginWithGoogle}>
      ...
      <Button variant="google" size="xl" height="l" onClick={loginWithMetamask}>
        <div className="flex gap-4 justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
